...
var ids = ['title', 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r'];

function MuxLogo() {
  var id = (0, _autoId.useId)();

  var _useMemo = (0, _react.useMemo)(() => ids.map(field => "".concat(id, "-").concat(field)), [id]),
      _useMemo2 = _slicedToArray(_useMemo, 19),
      titleId = _useMemo2[0],
      a = _useMemo2[1],
      b = _useMemo2[2],
      c = _useMemo2[3],
  ...
  return /*#__PURE__*/_react.default.createElement("svg", {
    ...
    id: titleId
  }, "Mux Logo"), /*#__PURE__*/_react.default.createElement("defs", null, /*#__PURE__*/_react.default.createElement("linearGradient", {
    id: c,
    spreadMethod: "pad",

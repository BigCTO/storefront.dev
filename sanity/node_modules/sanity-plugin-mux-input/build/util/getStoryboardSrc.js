...
exports.getStoryboardSrc = getStoryboardSrc;
...
function getStoryboardSrc(_ref) {
  ...
  if ((0, _isSigned.isSigned)(asset, secrets)) {
    var token = (0, _generateJwt.generateJwt)(playbackId, // eslint-disable-next-line no-warning-comments
    // @TODO figure out why isSigned doesn't manage to narrow down secrets to SignableSecrets
    secrets.signingKeyId, secrets.signingKeyPrivate, 's');

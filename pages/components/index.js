  ...
  return (
    <div className="mx-auto py-10 md:py-20 px-3 md:px-6 lg:px-8 bg-gray-900">
        ...
        <div className="w-full max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 border-b border-gray-200 pb-10">
            <div className="col-span-1">
              <h2 className="font-semibold text-sm text-gray-50">Page Sections</h2>
            </div>
            <div className="col-span-1 md:col-span-3 grid grid-cols-2 md:grid-cols-6 gap-4">
              ...
              <div className="col-span-1 md:col-span-2 w-full h-48 border border-gray-200 rounded-sm p-5 hover:cursor-pointer">
                <div className="w-full h-full flex flex-col justify-end">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 border-b border-gray-200 py-10">
            <div className="col-span-1">
            ...
            <div className="col-span-1 md:col-span-3 grid grid-cols-2 md:grid-cols-6 gap-4">
              ...
              <Link href="/components/products/options" passHref className="col-span-1 md:col-span-2 w-full h-48 border border-gray-200 rounded-sm p-5 hover:cursor-pointer">
                <div className="w-full h-full flex flex-col justify-end">
